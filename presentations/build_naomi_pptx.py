"""Build the Naomi AI study platform pitch deck following the
...
def add_footer(slide, page_num, total):
    ...
    add_text(slide, Inches(0.4), Inches(7.05), Inches(5), Inches(0.3),
             "NAOMI  ·  AI Study Buddy", size=10, bold=True, color=DEEP_RED)
...
def make_title_slide(prs):
    ...
    add_text(slide, Inches(0.7), Inches(1.8), Inches(12), Inches(1.6),
             "NAOMI", size=96, bold=True, color=DEEP_RED)
    ...
    add_text(slide, Inches(0.7), Inches(6.15), Inches(8), Inches(0.4),
             "Presented by Team Naomi", size=12, color=INK)
...
def slide_idea(slide):
    ...
    add_text(slide, Inches(1.0), Inches(2.45), Inches(11.4), Inches(1.4),
             "Naomi is an AI study buddy that turns lecture notes, slides,\n"
    ...
    descs = [
        "Upload any material — Naomi summarizes it in your style and "
...
def build():
    ...
    make_section_slide(prs, 1, "OUR START-UP IDEA IS…",
                       "Naomi turns any course into a personal AI tutor.",
                       slide_idea, page=2)
    ...
    make_section_slide(prs, 4, "OUR IMPACT",
                       "Naomi reduces drop-outs and improves grades.",
                       slide_impact, page=5)
    ...
    out = "/home/user/ilmkhona0.com.co/presentations/Naomi_Startup_Pitch.pptx"
    prs.save(out)
    print(f"Saved: {out}")

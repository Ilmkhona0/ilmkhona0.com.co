// Login-only page. Three options:
//   1. Google
//   2. GitHub
//   3. Email + Password (auto-registers on first use)
"use client";
    ...
    <div className="auth-shell">
      <div className="auth-card">
        ...
        <p className="auth-foot">
          New here? Just type your email and a password — your account will be created automatically.
        </p>
